...
p1 <- ggplot() +
  ...
  geom_sf(data = lines_sf, color = "darkred", size = 0.05) +
  geom_sf(data = origin, color = "darkblue", shape = 21) +
  geom_sf(data = centroids, aes(size = pop_est), color = "darkred", shape = 21) +
...
p2 <- ggplot() +
  geom_sf(data = world, fill = "grey90", color = "white") +
  geom_sf(data = lines_sf_gc, color = alpha("darkred", 0.2), linewidth = 0.5) +
  geom_sf(data = origin, color = "darkblue", shape = 21) +
  geom_sf(data = centroids, aes(size = pop_est), show.legend = FALSE, color = "darkred", shape = 21) +
...
p3 <- ggplot() +
  geom_sf(data = world, fill = "grey90", color = "white") +
  geom_curve(data = curve_data, aes(x = x, y = y, xend = xend, yend = yend),
             curvature = 0.2, color = alpha("darkblue", 0.9), linewidth = 0.05) +
  geom_sf(data = origin, color = "darkblue", shape = 21) +
...
p4 <- ggplot() +
  ...
  geom_curve(data = curve_data,
             ...
             curvature = 0.2, color = "grey30", 
             linewidth = 0.05) +
  geom_sf(data = origin, color = "darkblue", shape=21) +
  geom_point(aes(x = 0, y = 0), color = "darkblue", shape = 21) +
  geom_sf(data = lines_sf, linewidth = 0.05,color = "darkred") +
